...
// удаление сессии - файл сессии удаляется, но id сессии сохраняется в cookie.
// session_destroy();

// Изменить время жизни сессии можно в настройках php.ini или установить из PHP с помощью команды ini_set()
